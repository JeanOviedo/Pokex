...
export default function Footer() {
    return (<div className="footer">
        ...
        <p>
            ...
            , es una app que muestra información de pokemones esta  fue creada con
                    JavaScript, CSS, React, Redux con la API de POKEAPI complementando con una base de datos utilizando Express,
