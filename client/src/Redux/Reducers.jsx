      ...
      if (action.error == false) {
        ...
        return {
          ...
          modal: {
            ...
            boton: true,
            image:
              "https://media4.giphy.com/media/M90xtnaT605xjPX0ty/giphy.gif?cid=6c09b952b179dafd8e7333d6ef72f6bb51e572f4e225ff46&rid=giphy.gif&ct=s",
            visible: true,
          },
        };
      }
      ...
      if (action.error == true) {
        return {
          ...
          modal: {
            visible: true,
            mensaje:
              "Error Pokemon No se guardo, posiblemente hubo un error al conectar con la base de datos",
            boton: true,
            image:
      ...
      if (orden.length && action.payload !== "muestratodo") {
        ...
        return {
          ...
          modal: {
            visible: true,
            mensaje:
              "No se encontraron pokemons de tipo " + action.payload + ". ",
            image:
              "https://downloadwap.com/thumbs3/screensavers/d/new/games/pokemon-117647.gif",
            boton: true,
            accion: "",
    ...
    case ORDEN_POR_FUERZA_MENOS:
      ...
      case ORDEN_DB:
        ...
        if (action.payload === "all") {
            return {
                ...state,
                pokemonesordenados: state.pokemonios,
                pokemonestodosmuestra: true,
                pokemonbuscadocard: false,
                pokemonesordenadoscard: false,
              };
